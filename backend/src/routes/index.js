...
import { listDepartments } from '../controllers/intern.controller.js';
...
router.get('/departments/open-for-internship', requireAuth, requireRole('candidate'), listDepartments);
