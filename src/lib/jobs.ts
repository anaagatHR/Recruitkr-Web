...
const seedJobs: Job[] = [
  { id: "j1", title: "Senior Frontend Engineer", company: "Nimbus Technologies", companyId: "c1", location: "Bengaluru", type: "Full-time", workMode: "Hybrid", salaryMin: 18, salaryMax: 32, experience: "4-7 yrs", sector: "Information Technology", skills: ["React", "TypeScript", "Next.js"], description: "Build delightful, high-performance web apps used by millions.", postedAt: hoursAgo(3), applicants: 47, openings: 2, featured: true, companyRating: 4.6 },
  ...
  { id: "j3", title: "Credit Risk Analyst", company: "FinEdge Capital", companyId: "c3", location: "Gurugram", type: "Full-time", workMode: "On-site", salaryMin: 9, salaryMax: 15, experience: "3-6 yrs", sector: "Banking & Finance", skills: ["Risk", "SQL", "Excel"], description: "Own credit-risk models for our digital lending book.", postedAt: hoursAgo(20), applicants: 18, openings: 1, featured: true, companyRating: 4.1 },
  ...
  { id: "j7", title: "Product Marketing Intern", company: "Nimbus Technologies", companyId: "c1", location: "Remote", type: "Internship", workMode: "Remote", salaryMin: 0.3, salaryMax: 0.5, experience: "0-1 yrs", sector: "Information Technology", skills: ["Content", "SEO"], description: "Learn product marketing with a world-class team.", postedAt: hoursAgo(2), applicants: 88, openings: 2, featured: true, companyRating: 4.6 },
